...
(* OASIS_START *)
(* DO NOT EDIT (digest: ce0056197b15e780831529a93d92952b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Robert Soul\195\169"];
          homepage = None;
          bugreports = None;
          synopsis = "Measurement Calculus Language";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_digest = Some "\030P\240L\003\198-j\144\007\246L\128\225\251\135";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
